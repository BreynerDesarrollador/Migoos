<template>
    <div class="container-fluid" v-show="Object.keys(datosevento).length>0">
        ...
        <form accept-charset="UTF-8" action="/guardarevento" enctype="multipart/form-data" class="form_guardar"
            ...
            <div class="row">
                <div class="col-sm-12 col-md-8 col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title text-center text-dark">Editar evento</h1>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                    ...
                                    <input required class="form-control" :value="datosevento.nombre" name="nombre" id="nombre" type="text"/>
                                </div>
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                ...
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                    <label for="nombre">Dirección del evento:</label>
                                    <input required class="form-control" name="direccion" id="direccion" type="text"/>
                                </div>
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                ...
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                    ...
                                    <select-vue :name="'ciudad'" :opcion="'categoria'" :buscar="1"
                                                :option="{id:'',text:'Seleccione...'}"
                                                :datos="[]" :array="false"></select-vue>
                                </div>
                                ...
                                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                                    ...
                                    <select-vue :name="'tipo_evento'" :opcion="'tipo_evento'" :buscar="0"
                                                :option="{id:'',text:'Seleccione...'}" :datos="[]" :array="false">
                                    </select-vue>

                                </div>
                                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                                    <label for="costo">Costo $:</label>
                                    <input required class="form-control" value="0" name="costo" id="costo" type="text"/>
                                </div>
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                    <label for="latitud">Latitud:</label>
                                    <input required readonly class="form-control" name="latitud" id="latitud"
                                           type="text"/>
                                </div>
                                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                                    <label for="longitud">longitud:</label>
                                    <input required readonly class="form-control" name="longitud" id="longitud"
                                           type="text"/>
                                </div>
                ...
                <div class="col-sm-12 col-md-4 col-xl-4">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-center">Agregar imagen al evento</h3>
                        </div>
                        <div class="card-body">
    ...
    export default {
        ...
        methods: {
            ...
            obtenerdatos(id) {
                ...
                axios.get('/edit/'+id)
                    .then(data =>{
                        this.datosevento=data.data[0];
                        this.loading=false;
                }).catch(error =>{
                    toastr.danger(error.responseText);
                });
            }
        }
    }
